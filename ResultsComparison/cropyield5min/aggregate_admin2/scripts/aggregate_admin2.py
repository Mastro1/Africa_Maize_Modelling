"""
This script aggregates the crop yield data from the paper "Crop yield 5 min" at the admin 2 level for comparison reasons.
It extracts average yield values for each administrative unit (FNID) from GeoTIFF files spanning 1982-2015.
"""
...
INPUT_DIR = "ResultsComparison/cropyield5min/data"
OUTPUT_DIR = "ResultsComparison/cropyield5min/aggregate_admin2"
...
def main():
    ...
    if results:
        ...
        output_path = os.path.join(OUTPUT_DIR, f"{CROP_TYPE.lower()}_yield_admin2_{START_YEAR}_{END_YEAR}.csv")
