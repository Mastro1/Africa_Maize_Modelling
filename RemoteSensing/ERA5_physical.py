...
def extractERA5(country_name: str, start_date_str: str, end_date_str: str, 
    ...
    def rename_properties(feature):
        new_props = {
            ...
            'volumetric_soil_water_layer_2': feature.get('volumetric_soil_water_layer_2'),
            'volumetric_soil_water_layer_3': feature.get('volumetric_soil_water_layer_3'),
            'surface_solar_radiation_downwards_sum': feature.get('surface_solar_radiation_downwards_sum')
        }
...
if __name__ == "__main__":
    if not EE_INITIALIZED:
        ...
        output_prefix = f"new_ERA5_timeseries"
