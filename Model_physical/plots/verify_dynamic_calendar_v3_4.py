...
def plot_season_strict(df_pcode, pcode, year, season_results, output_dir):
    ...
    # Standard IEEE double-column width
    width = 7.0 
    height = width * 0.5 
    ...
    ax1.set_ylabel('NDVI')
    ax1.set_title(f'Dynamic Season V3.4 (Strict Fenced) - {pcode} - {year}', loc='center')
    ...
    out_file = os.path.join(output_dir, f"{pcode}_{year}_v3.4_strict.pdf")
