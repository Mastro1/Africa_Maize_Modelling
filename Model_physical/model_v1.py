...
class MaizeYieldModel:
    def __init__(self, data_dir, fpar_file, era5_new_file, era5_gadm_file, calendar_file, output_dir, crop_area_file=None):
        """
    ...
    def load_and_merge_data(self):
        ...
        print(f"  - Combined dataframe size: {len(df_daily)}")
    ...
    def load_crop_calendar(self):
         ...
         try:
             ...
             cols = ['PCODE', 'Maize_1_planting', 'Maize_1_harvest']
    ...
    def calculate_yield_estimates(self, df_daily, df_calendar):
        ...
        for pcode in pcodes:
            ...
            harvest_doy = cal_row.iloc[0]['Maize_1_harvest']
